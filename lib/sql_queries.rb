...
"SELECT users.name, SUM(pledges.amount)  FROM pledges JOIN users ON pledges.user_id=users.id GROUP BY users.name ORDER BY SUM(pledges.amount) ASC, users.name"
